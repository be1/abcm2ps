...
#define FORMAT_S 5	/* string */
    ...
    {"abc2pscompat", &cfmt.abc2pscompat, FORMAT_B, 3, 0},
    {"alignbars", &cfmt.alignbars, FORMAT_I, 0, 0},
    {"aligncomposer", &cfmt.aligncomposer, FORMAT_I, 0, 0},
    {"annotationfont", &cfmt.font_tb[ANNOTATIONFONT], FORMAT_F, 0, 0},
    {"autoclef", &cfmt.autoclef, FORMAT_B, 0 ,0},
    {"barsperstaff", &cfmt.barsperstaff, FORMAT_I, 0, 0},
    {"bgcolor", &cfmt.bgcolor, FORMAT_S, 0, 0},
    {"botmargin", &cfmt.botmargin, FORMAT_U, 1, 0},
    {"breaklimit", &cfmt.breaklimit, FORMAT_R, 3, 0},
    {"breakoneoln", &cfmt.breakoneoln, FORMAT_B, 0, 0},
    {"bstemdown", &cfmt.bstemdown, FORMAT_B, 0, 0},
    {"cancelkey", &cfmt.cancelkey, FORMAT_B, 0, 0},
    {"capo", &cfmt.capo, FORMAT_I, 0, 0},
    {"combinevoices", &cfmt.combinevoices, FORMAT_I, 0, 0},
    {"composerfont", &cfmt.font_tb[COMPOSERFONT], FORMAT_F, 0, 0},
    {"composerspace", &cfmt.composerspace, FORMAT_U, 0, 0},
    {"contbarnb", &cfmt.contbarnb, FORMAT_B, 0, 0},
    {"continueall", &cfmt.continueall, FORMAT_B, 0, 0},
    {"custos", &cfmt.custos, FORMAT_B, 0, 0},
    {"dateformat", &cfmt.dateformat, FORMAT_S, 0, 0},
    {"dblrepbar", &cfmt.dblrepbar, FORMAT_I, 2, 0},
    {"decoerr", &cfmt.decoerr, FORMAT_B, 0, 0},
    {"dynalign", &cfmt.dynalign, FORMAT_B, 0, 0},
    {"footer", &cfmt.footer, FORMAT_S, 0, 0},
    {"footerfont", &cfmt.font_tb[FOOTERFONT], FORMAT_F, 0, 0},
    {"flatbeams", &cfmt.flatbeams, FORMAT_B, 0, 0},
    {"flatbeamgracing", &cfmt.flatbeamgracing, FORMAT_B, 0, 0},
    {"gchordbox", &cfmt.gchordbox, FORMAT_B, 0, 0},
    {"gchordfont", &cfmt.font_tb[GCHORDFONT], FORMAT_F, 3, 0},
    {"graceslurs", &cfmt.graceslurs, FORMAT_B, 0, 0},
    {"graceword", &cfmt.graceword, FORMAT_B, 0, 0},
    {"gracespace", &cfmt.gracespace, FORMAT_I, 5, 0},
    {"gutter", &cfmt.gutter, FORMAT_U, 0, 0},
    {"header", &cfmt.header, FORMAT_S, 0, 0},
    {"headerfont", &cfmt.font_tb[HEADERFONT], FORMAT_F, 0, 0},
    {"historyfont", &cfmt.font_tb[HISTORYFONT], FORMAT_F, 0, 0},
    {"hyphencont", &cfmt.hyphencont, FORMAT_B, 0, 0},
    {"indent", &cfmt.indent, FORMAT_U, 0, 0},
    {"infofont", &cfmt.font_tb[INFOFONT], FORMAT_F, 0, 0},
    {"infoline", &cfmt.infoline, FORMAT_B, 0, 0},
    {"infospace", &cfmt.infospace, FORMAT_U, 0, 0},
    {"keywarn", &cfmt.keywarn, FORMAT_B, 0, 0},
    {"landscape", &cfmt.landscape, FORMAT_B, 0, 0},
    {"leftmargin", &cfmt.leftmargin, FORMAT_U, 1, 0},
    {"lineskipfac", &cfmt.lineskipfac, FORMAT_R, 0, 0},
    {"linewarn", &cfmt.linewarn, FORMAT_B, 0, 0},
    {"maxshrink", &cfmt.maxshrink, FORMAT_R, 2, 0},
    {"maxstaffsep", &cfmt.maxstaffsep, FORMAT_U, 0, 0},
    {"maxsysstaffsep", &cfmt.maxsysstaffsep, FORMAT_U, 0, 0},
    {"measurebox", &cfmt.measurebox, FORMAT_B, 0, 0},
    {"measurefirst", &cfmt.measurefirst, FORMAT_I, 0, 0},
    {"measurefont", &cfmt.font_tb[MEASUREFONT], FORMAT_F, 2, 0},
    {"measurenb", &cfmt.measurenb, FORMAT_I, 0, 0},
    {"musicfont", &cfmt.musicfont, FORMAT_S, 1, 0},
    {"musicspace", &cfmt.musicspace, FORMAT_U, 0, 0},
    {"notespacingfactor", &cfmt.notespacingfactor, FORMAT_R, 1, 0},
    {"oneperpage", &cfmt.oneperpage, FORMAT_B, 0, 0},
    {"pageheight", &cfmt.pageheight, FORMAT_U, 1, 0},
    {"pagewidth", &cfmt.pagewidth, FORMAT_U, 1, 0},
    {"pagescale", &cfmt.scale, FORMAT_R, 0, 0},
#ifdef HAVE_PANGO
    {"pango", &cfmt.pango, FORMAT_B, 2, 0},
#endif
    {"parskipfac", &cfmt.parskipfac, FORMAT_R, 0, 0},
    {"partsbox", &cfmt.partsbox, FORMAT_B, 0, 0},
    {"partsfont", &cfmt.font_tb[PARTSFONT], FORMAT_F, 1, 0},
    {"partsspace", &cfmt.partsspace, FORMAT_U, 0, 0},
    {"pdfmark", &cfmt.pdfmark, FORMAT_I, 0, 0},
    {"rbdbstop", &cfmt.rbdbstop, FORMAT_B, 0, 0},
    {"rbmax", &cfmt.rbmax, FORMAT_I, 0, 0},
    {"rbmin", &cfmt.rbmin, FORMAT_I, 0, 0},
    {"repeatfont", &cfmt.font_tb[REPEATFONT], FORMAT_F, 0, 0},
    {"rightmargin", &cfmt.rightmargin, FORMAT_U, 1, 0},
//	{"scale", &cfmt.scale, FORMAT_R, 0},
    {"setdefl", &cfmt.setdefl, FORMAT_B, 0, 0},
//	{"shifthnote", &cfmt.shiftunison, FORMAT_B, 0},	/*to remove*/
    {"shiftunison", &cfmt.shiftunison, FORMAT_I, 0, 0},
    {"slurheight", &cfmt.slurheight, FORMAT_R, 0, 0},
    {"splittune", &cfmt.splittune, FORMAT_I, 1, 0},
    {"squarebreve", &cfmt.squarebreve, FORMAT_B, 0, 0},
    {"staffnonote", &cfmt.staffnonote, FORMAT_I, 0, 0},
    {"staffsep", &cfmt.staffsep, FORMAT_U, 0, 0},
    {"staffwidth", &staffwidth, FORMAT_U, 2, 0},
    {"stemheight", &cfmt.stemheight, FORMAT_R, 0, 0},
    {"straightflags", &cfmt.straightflags, FORMAT_B, 0, 0},
    {"stretchlast", &cfmt.stretchlast, FORMAT_R, 2, 0},
    {"stretchstaff", &cfmt.stretchstaff, FORMAT_B, 0, 0},
    {"subtitlefont", &cfmt.font_tb[SUBTITLEFONT], FORMAT_F, 0, 0},
    {"subtitlespace", &cfmt.subtitlespace, FORMAT_U, 0, 0},
    {"sysstaffsep", &cfmt.sysstaffsep, FORMAT_U, 0, 0},
    {"tempofont", &cfmt.font_tb[TEMPOFONT], FORMAT_F, 0, 0},
    {"textfont", &cfmt.font_tb[TEXTFONT], FORMAT_F, 0, 0},
    {"textoption", &cfmt.textoption, FORMAT_I, 4, 0},
    {"textspace", &cfmt.textspace, FORMAT_U, 0, 0},
    {"tieheight", &cfmt.tieheight, FORMAT_R, 0, 0},
    {"titlecaps", &cfmt.titlecaps, FORMAT_B, 0, 0},
    {"titlefont", &cfmt.font_tb[TITLEFONT], FORMAT_F, 0, 0},
    {"titleformat", &cfmt.titleformat, FORMAT_S, 0, 0},
    {"titleleft", &cfmt.titleleft, FORMAT_B, 0, 0},
    {"titlespace", &cfmt.titlespace, FORMAT_U, 0, 0},
    {"titletrim", &cfmt.titletrim, FORMAT_I, 0, 0},
    {"timewarn", &cfmt.timewarn, FORMAT_B, 0, 0},
    {"topmargin", &cfmt.topmargin, FORMAT_U, 1, 0},
    {"topspace", &cfmt.topspace, FORMAT_U, 0, 0},
    {"tuplets", &cfmt.tuplets, FORMAT_I, 3, 0},
    {"vocalfont", &cfmt.font_tb[VOCALFONT], FORMAT_F, 0, 0},
    {"vocalspace", &cfmt.vocalspace, FORMAT_U, 0, 0},
    {"voicefont", &cfmt.font_tb[VOICEFONT], FORMAT_F, 0, 0},
    {"wordsfont", &cfmt.font_tb[WORDSFONT], FORMAT_F, 0, 0},
    {"wordsspace", &cfmt.wordsspace, FORMAT_U, 0, 0},
    {"writefields", &cfmt.fields, FORMAT_B, 1, 0},
